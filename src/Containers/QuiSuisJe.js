...
export default function QuiSuisJe() {
  return (
    <div className='quiSuisJe'>
      ...
      <img className='photo-profil' src={Photo} alt="photo du profil" />

      <section className='quiSuisJeSection'>
        <article className='quiSuisJeArticle'>

          <h3 className='quiSuisJeH3'> introduction</h3>
          <p className='quiSuisJeP'>Antoine Carrette, 32 ans au moment où j'écris ces lignes, originaire du Nord et résidant à l'heure actuelle à Marseille.
          </p>
